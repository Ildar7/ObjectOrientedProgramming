...
namespace OOPLAB2
{
    public partial class Form1 : Form
    {
        ...
        {
            FormPolygon pg = new FormPolygon(pictureBox1, bitmap, buttonPG, comboBox1);
            pg.Show();
            buttonPG.Enabled = false;
        }

        private void buttonTG_Click(object sender, EventArgs e)
        {
            FormTriangle tg = new FormTriangle(pictureBox1, bitmap, buttonTG, comboBox1);
            tg.Show();
        ...
        {
            FormHelicopter hc = new FormHelicopter(pictureBox1, bitmap, buttonHC, comboBox1);
            hc.Show();
