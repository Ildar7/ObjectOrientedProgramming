...
namespace OOPLAB2
{
    public partial class FormRectangle : Form
    {
        ...
        public FormRectangle(PictureBox pic, Bitmap bmp, Button butt, ComboBox cmbbx)
        {
            InitializeComponent();
            this.pic = pic;
            this.bmp = bmp;
            this.butt = butt;
            rect = new FLib.Rectangle(pic, bmp, cmbbx);
        }
        ...
        private void BDraw_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rect = new FLib.Rectangle(x, y, w, h, pic, bmp, cmbbx);
                rect.Draw();
                BDraw.Enabled = false;
            }
            catch (Exception ex)
